...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a href="index.php"><font color="black">About Meetutu</font></a></li>
                                    <li><a href="login1.php"><font color="black">Login</font></a></li>
        ...
        <div class="g-signin2" data-onsuccess="onSignIn" data-theme="dark" target="_self">Login With Google</div>
        <!-- <a class="fb" href="http://deepak646.blogspot.in/" target="_blank">Login With Google</a></center> -->
...
<div class="form">
    <form method="post" action="register.php">
        ...
        <div class="text-xs-center">
            <center>
            <button name="btnsubmit" id="btnsubmit" class="btn btn-deep-purple"/>Sign Up</button>
        </div>
